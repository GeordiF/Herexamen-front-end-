    ...
    onSubmit(e) {
        ...
        if (this.state.person.name != 0
          ...
          && this.state.person.gender != 0) {
            peopleService.add(this.state.person).then(() => this.props.history.push('/people'));
        }
      ...
      return(
        <div>
            ...
            <div className='home-content add'>
                <h2>Voeg een nieuwe hartendief toe!</h2>
                <form action="" onSubmit={(e) => this.onSubmit(e)}>
                  <figure className="avatar big">
                    ...
                    <table>
                      <tr>
                        <td>
                        <label>Naam:</label>
                        <input  placeholder= "e.g. Horgei Fastbender" className={checkName} value={this.state.person.name} required onChange={(e) => this.updateName(e.target.value)} onClick={(e) =>this.Empty()}></input>
                        </td>
                        <td>
                  ...
                  <button id='plus-btn' type="submit"><span>Voeg toe!</span></button>
                </form>
            </div>
        </div>
